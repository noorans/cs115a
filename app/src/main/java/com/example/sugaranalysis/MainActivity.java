...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToDataBase(String bs, String moment){
        ...
        String time = "Time: " + timeformat.format(c.getTime());
        String height = "Height: " + myPreferences.getString("userHeight","");
        String weight = "Weight: " + myPreferences.getString("userWeight", "");
